...
enum TasmotaCommands {
  ...
  CMND_COUNTERDEBOUNCE, CMND_ENCODER, CMND_BUTTONDEBOUNCE, CMND_SWITCHDEBOUNCE, CMND_SLEEP, CMND_UPGRADE, CMND_UPLOAD, CMND_OTAURL, CMND_SERIALLOG, CMND_SYSLOG,
...
const char kTasmotaCommands[] PROGMEM =
  ...
  D_CMND_COUNTERDEBOUNCE "|" D_CMND_ENCODER "|" D_CMND_BUTTONDEBOUNCE "|" D_CMND_SWITCHDEBOUNCE "|" D_CMND_SLEEP "|" D_CMND_UPGRADE "|" D_CMND_UPLOAD "|" D_CMND_OTAURL "|" D_CMND_SERIALLOG "|" D_CMND_SYSLOG "|"
...
uint8_t encoder_no_pullup = 0;              // Encoder input pullup flag (1 = no pullup)
