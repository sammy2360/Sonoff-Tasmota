...
#define USE_I2CENCODER                             // Enable i2c rotary encoder support (i2c address 0x01)
#define NUMBER_OF_ENCODERS 1                       // Number of Encoders attached to i2c bus, maximum 4 (addressed 0x01 to 0x04)
